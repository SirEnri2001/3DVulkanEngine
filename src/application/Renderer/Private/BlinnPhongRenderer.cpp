...
void BlinnPhongRenderer::CreateResource() {
    ...
    LoadGLTFTestScene("./models/gltf/Sponza/glTF/Sponza.gltf", "./models/spot/spot_texture.png");
...
void BlinnPhongRenderer::LoadGLTFTestScene(const std::string& GltfPath, const std::string& TexturePath)
{
...
void BlinnPhongRenderer::UpdateUniforms(float4 ViewPos, RenderControl* control) {
    ...
    uboData.proj = glm::perspective(glm::radians(45.0f), Aspect, 0.1f, 3000.f);
